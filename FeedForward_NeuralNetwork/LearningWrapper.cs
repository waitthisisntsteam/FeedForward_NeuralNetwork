...
{
    public class LearningWrapper <T>
    {
        public LearningObject<T>[] Population;

        public LearningWrapper(int count, LearningObject<T>[] learningObject)
        {
            Population = new LearningObject<T>[count];
